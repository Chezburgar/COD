...
export const WEAPONS = {
  ...
  sr90: {
    ...
    adsTime: 0.3, adsFov: 0.86, sight: 'scope', scope: { zoom: 8, style: 0, radius: 0.4 },
  ...
  dm12: {
    ...
    adsTime: 0.24, adsFov: 0.88, sight: 'scope', scope: { zoom: 4, style: 1, radius: 0.34 },
  ...
  p9: {
    ...
    adsTime: 0.16, adsFov: 0.72, sight: 'iron', scope: null,
  ...
  p9s: {
    ...
    mag: 17, reserve: 68, reloadTac: 1.35, reloadEmpty: 1.85,
    adsTime: 0.18, adsFov: 0.72, sight: 'iron', scope: null,
  ...
  r44: {
    ...
    adsTime: 0.22, adsFov: 0.70, sight: 'iron', scope: null,
